 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.ecore.test.impl.PlantImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlantImpl extends MinimalEObjectImpl.Container implements Plant {
	...
	public void setColor(Color newColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.PLANT__COLOR, oldColor, color));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TestPackage.PLANT___COMMUNICATE:
				communicate();
				return null;
		}
